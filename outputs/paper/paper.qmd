...
In conclusion, the findings of this study underscore the importance of equitable access to public WiFi in fostering urban connectivity and social inclusion.         By addressing disparities in WiFi distribution and prioritizing digital equity in urban policy and planning initiatives, cities can create more resilient, connected, and equitable communities for all residents.

Also, by targeting building types with limited connectivity, policymakers can work towards improving the wifi  coverage in relatively backward buildings and promoting inclusivity in urban development efforts.                can work towards closing the digital divide and promoting inclusivity in urban development efforts.
